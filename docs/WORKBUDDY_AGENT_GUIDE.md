...
**文档同日改**：本指南新增 **§27.6**、§27.5 遗留 ① 加删除线指向本节、抬头 `temp/*.py` 轮次范围 `D2–D19` → `D2–D20`、版本留痕新增 **v3.6**；`prompt.md` 一处 —— 把 D19 写下的「6.3 与 6.4 都照不到这 21 条」前瞻注换成 6.5 实况，指针扩到 **§27.6**；`qa_report.md` 抬头二十→**二十一处**、新增**第 21 项**、§1 与 §6.2 基线同步；`docs/交接_2026-09-02_D19结案_换平台接手卡.md` 更新基线数字与 md5 链、§5 待拍板第 ① 项结案、§4 改写为 D20。记忆两处同步。
