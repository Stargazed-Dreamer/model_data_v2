...
| `D42_REPORT.md` | D42：**`model_id` 点号口径统一（小数一律写 `.`）**——证据驱动判据（`full_name`/`version` 原文含 `a.b` 才转换），改名 314 family / 317 条，family 含点号 6→318，碰撞 0；废止 `prompt.md` §6.4 冲突的 P1 禁令；含 s1 家族等 4 类结构问题的下一轮建议 |
